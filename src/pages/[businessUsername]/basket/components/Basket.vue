<template>
  <div v-if="getBasket.length" class="bg-base-200 rounded-box p-4 ">
    ...
    >
      <template #basket>
        <div
          class="inline-block bg-error text-secondary-content rounded-lg flex items-center hover:bg-base-200 hover:cursor-pointer transition delay-20"
        ...
        <div
          class="inline-block bg-success text-secondary-content rounded-lg flex items-center hover:bg-base-200 hover:cursor-pointer transition delay-20" @click="addToBasket(basketItem)"
        >
