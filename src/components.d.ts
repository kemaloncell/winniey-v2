...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    CarbonPercentage: typeof import('~icons/carbon/percentage')['default']
    CarbonPhone: typeof import('~icons/carbon/phone')['default']
    CarbonPlus: typeof import('~icons/carbon/plus')['default']
    CarbonRestaurantFine: typeof import('~icons/carbon/restaurant-fine')['default']
    CarbonRestuarntFine: typeof import('~icons/carbon/restuarnt-fine')['default']
